            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" action="<?=URL?>admin/handlers/createblog.php" enctype="multipart/form-data" class="form theme-form projectcreate">
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                <label>Blog Name</label>
                                                <input class="form-control" name="name" type="text" placeholder="Doctor name *">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">

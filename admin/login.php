...
<head>
    ...
    <link rel="icon" href="../../elhawra/admin/assets/images/logo/favicon-icon.png" type="image/x-icon">
    <link rel="shortcut icon" href="../../elhawra/admin/assets/images/logo/favicon-icon.png" type="image/x-icon">
    <title>Karem </title>
    <!-- Google font-->
      ...
      <div class="row">
        <div class="col-12">
          <div class="login-card">
            ...
            <form method="post" action="<?=URL?>admin/handlers/login.php" class="theme-form login-form">
              <h4>Login</h4>
              <h6>
